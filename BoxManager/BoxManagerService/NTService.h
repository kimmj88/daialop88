...
class CNTService {
	...
	protected:	// data members
		...
		LPCTSTR			m_pszServiceTag;		// extension
		TCHAR			m_szServiceName[64];	// extension
		TCHAR			m_szDisplayName[64];	// extension
	...
	public:		// overridables
		...
		virtual BOOL	DebugService(int argc, char **argv,BOOL faceless=FALSE);	//!! TCW MOD - added FACELESS parm to allow Win95 usage.
			...
			// Configure the service. Does nothing by default.
			// You can override this to configure the service.
